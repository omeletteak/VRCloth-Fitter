...
- [ ] **プリフライト診断** — 検出統計(最大深度・p95・侵入率・最大連結パッチ・深さ/カプセル半径比)からサポート範囲([docs/DESIGN.md](docs/DESIGN.md) 第9節)内かを緑/黄/赤判定し、赤は適用を既定で中止(bd: VRCloth-Fitter-noo)
- [ ] **E2E 検証** — 実アバター+衣装で貫通解消を確認(上記5項目の実機目視をまとめて行う。先にプリフライト診断を入れ、テスト自体の枠外適用を防ぐ)
